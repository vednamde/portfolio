...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="relative py-28 bg-gradient-to-b from-[#0B0C10] via-[#0E1118] to-[#0B0C10] text-center overflow-hidden"
    >
      {/* Background Glow */}
      ...
      <motion.div
        className="absolute top-20 left-10 text-[#6EE7F9]/30 text-6xl"
        animate={{ y: [0, 20, 0] }}
      ...
      <motion.div
        className="absolute bottom-20 right-10 text-[#C084FC]/30 text-6xl"
        animate={{ y: [0, -20, 0] }}
